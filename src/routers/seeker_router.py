...
from src.keyboards.seeker_inline_keyboards import SeekerPortfolioEditingInlineKeyboardMarkup
...
@seeker_router.callback_query(F.data == "position", MenuStates.seeker_profile_editing)
